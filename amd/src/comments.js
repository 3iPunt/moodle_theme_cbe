...
define([
        ...
        Comments.prototype.onExpandButtonClick = function (e) {
            var cmid = $(e.currentTarget).data('comment');
            var comment = this.node.find('.comments[data-comment="' + cmid +'"]');
            var button_contract = this.node.find('.contract-comments[data-comment="' + cmid +'"]');
        ...
        Comments.prototype.onContractButtonClick = function (e) {
            var cmid = $(e.currentTarget).data('comment');
            var comment = this.node.find('.comments[data-comment="' + cmid +'"]');
            var button_expand = this.node.find('.expand-comments[data-comment="' + cmid +'"]');
            $(e.currentTarget).hide();
            $(button_expand).show();
            $(comment).hide();
        };
